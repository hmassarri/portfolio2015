...
<body>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            ...
            -->
            <br /><br /><br />
            <a href="#about" class="btn btn-dark btn-lg">Check It Out</a>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Visual Designer / Front End Developer<br />Design Junkie / Part-time Bike Builder</h2>
    ...
    <section id="skills" class="services bg-skills">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="fa-stack fa-4x">
                                <i class="fa fa-circle fa-stack-2x"></i>
                                <i class="fa fa-apple fa-stack-1x text-primary"></i>
                            </span>
                                <h4>
                                    <strong>99%</strong>
                                </h4>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                <span class="fa-stack fa-4x">
                                <i class="fa fa-circle fa-stack-2x"></i>
                                <i class="fa fa-drupal fa-stack-1x text-primary"></i>
                            </span>
                                <h4>
                                    <strong>89%</strong>
                                </h4>
    ...
    <section id="contact" class="map">
        <iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d24275.336937773416!2d-74.44128245000002!3d40.48815845000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c3c65b6f09cf79%3A0x26738ad34043ac7a!2sNew+Brunswick%2C+NJ+08901!5e0!3m2!1sen!2sus!4v1439583979886"></iframe>
        <br />
        <small>
