...
<body>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li>
                <a href="#showmay" onclick = $("#menu-close").click(); >Showmay Heimbuch, Accountant</a>
            </li>
            <li>
            ...
            <li>
                <a href="#wram" onclick = $("#menu-close").click(); >WRAM 2015</a>
            </li>
            <br />
            <li class="sidebar-brand">
                Main Menu
            ...
            <li>
                <a href="index.html#skills" onclick = $("#menu-close").click(); >Skills</a>
            </li>
            <li>
                <a href="index.html#projects" onclick = $("#menu-close").click(); >Projects</a>
            </li>
            <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="lead"><i>-Dieter Rams</i></p>
                </div>
            </div>
            <!-- /.row -->
        </div>
